...
Все репозитории и блоки покрыты тестами, есть виджет-тесты для экрана персонажей и для виджета favorites_toggle_button, есть 1 интеграционный тест на проверку добавления в избранное
